...
--* No Portal da Agenda, o AK poderá ordenar os botões das Clínicas por TiConsulta e sigla da clínica
...
add /* 31*/	QTASCOMPLE INTEGER; /* Máscara = N */
commit;
...
INSERT INTO ARQTIAGENDA (IDPRIMARIO, TIAGENDA, ORDEM, ATIVO, COMPLEMEN, DOBROTEMPO, PAGAMENTO, MIDIA) 
	VALUES (8, 'APLICAÇÃO', 8, 1, 0, 0, 0, 0);
COMMIT WORK;
