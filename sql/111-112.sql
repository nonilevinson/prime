...
/************************************************************
	Arquivo CCor      
************************************************************/
INSERT INTO ARQCCOR (IDPRIMARIO, NOME, CLINICA, BANCO, AGENCIA, DVAGENCIA, CONTA, DVCONTA, CARTEIRA, CODCEDENTE, MULTA, JUROS, CBOLETO, ULTREMESSA, CONVENIO, VARIACAO, ATIVO, TPIX1, PIX1, TPIX2, PIX2, TPIX3, PIX3, TPIX4, PIX4, TPIX5, PIX5) 
	VALUES (2, 'CAIXA RECEPÇÃO', NULL, NULL, '', '', '', '', 0, '', 0, 0, 0, 0, '', 0, 1, NULL, '', NULL, '', NULL, '', NULL, '', NULL, '');
INSERT INTO ARQCCOR (IDPRIMARIO, NOME, CLINICA, BANCO, AGENCIA, DVAGENCIA, CONTA, DVCONTA, CARTEIRA, CODCEDENTE, MULTA, JUROS, CBOLETO, ULTREMESSA, CONVENIO, VARIACAO, ATIVO, TPIX1, PIX1, TPIX2, PIX2, TPIX3, PIX3, TPIX4, PIX4, TPIX5, PIX5) 
	VALUES (3, 'CAIXA ASSESSOR', NULL, NULL, '', '', '', '', 0, '', 0, 0, 0, 0, '', 0, 1, NULL, '', NULL, '', NULL, '', NULL, '', NULL, '');
COMMIT WORK;
...
--* criei para usar no XConfig
INSERT INTO ARQFORNECEDOR (IDPRIMARIO, NOME, APELIDO, TPFPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, CNPJ, INSCESTAD, INSCMUNIC, CPF, IDENTIDADE, ORGAO, EMISSAO, ATIVO, OBS, DESDE) 
	VALUES (3400, 'PRIME MEDICAL CENTER', 'PRIME MEDICAL', 2, '', '', NULL, NULL, '', 0, '', 0, '', '', '', '', '', '', NULL, 1, 'Criado pelo Noni para ser configurado como o fornecedor de aporte nos caixas da recepção e do assessor', '2021-10-31');
COMMIT WORK;
...
add /* 27*/	FORNREC ligadoComArquivo; /* Ligado com o Arquivo Fornecedor */
commit;
...
update cnfXConfig set CCorRec=2, CCorAss=3, SubPlaRRec=9, SubPlaRAss=8, FornRec=3400;
commit;
