...
INSERT INTO ARQCLINICA (IDPRIMARIO, CLINICA, RAZAO, EMAIL, CNPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, ATIVO) VALUES (2, 'Rio de Janeiro', '', '', '', '', 'Avenida Treza de Maio, 43', 1, 2, '', 0, '', 0, 1);
INSERT INTO ARQCLINICA (IDPRIMARIO, CLINICA, RAZAO, EMAIL, CNPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, ATIVO) VALUES (3, 'Juiz de Fora', '', '', '', '36025320', 'Avenida Presidente Itamar Franco', NULL, 3, '', 0, '', 0, 1);
INSERT INTO ARQCLINICA (IDPRIMARIO, CLINICA, RAZAO, EMAIL, CNPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, ATIVO) VALUES (4, 'Caxias do Sul', '', '', '', '', 'Rua Doutor Montaur, 1441', 1, 4, '', 0, '', 0, 1);
COMMIT WORK;

--* ARQPESSOA
INSERT INTO ARQPESSOA (IDPRIMARIO, NOME, APELIDO, TPESSOA, TPFPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, CNPJ, INSCESTAD, INSCMUNIC, NASCIMENTO, IDADE, SEXO, ESTCIVIL, PROFISSAO, CPF, IDENTIDADE, ORGAO, EMISSAO, EMAIL, RECEMAIL, ATIVO, OBS, DESDE, QTODESMAR, MIDIA) VALUES (1, 'João da Silva', 'João', 2, 1, '', '', NULL, NULL, '', 0, '', 0, '', '', '', '1964-01-20', 57, 1, 4, 4, '', '', '', NULL, '', 0, 1, NULL, '2021-05-23', 0, 5);
INSERT INTO ARQPESSOA (IDPRIMARIO, NOME, APELIDO, TPESSOA, TPFPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, CNPJ, INSCESTAD, INSCMUNIC, NASCIMENTO, IDADE, SEXO, ESTCIVIL, PROFISSAO, CPF, IDENTIDADE, ORGAO, EMISSAO, EMAIL, RECEMAIL, ATIVO, OBS, DESDE, QTODESMAR, MIDIA) VALUES (2, 'Joaquim Ferreira', 'Joaquim', 2, 1, '', '', NULL, NULL, '', 0, '', 0, '', '', '', '1989-05-23', 32, 1, 1, 3, '', '', '', NULL, '', 0, 1, NULL, '2021-05-23', 3, NULL);
INSERT INTO ARQPESSOA (IDPRIMARIO, NOME, APELIDO, TPESSOA, TPFPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, CNPJ, INSCESTAD, INSCMUNIC, NASCIMENTO, SEXO, ESTCIVIL, PROFISSAO, CPF, IDENTIDADE, ORGAO, EMISSAO, EMAIL, RECEMAIL, ATIVO, DESDE, QTODESMAR, MIDIA) VALUES (3, 'ABC Comércio', 'ABC', 1, 2, '', '', NULL, NULL, '', 0, '', 0, '', '', '', NULL, NULL, NULL, NULL, '', '', '', NULL, '', 0, 1, '2021-05-31', 0, NULL);
INSERT INTO ARQPESSOA (IDPRIMARIO, NOME, APELIDO, TPESSOA, TPFPJ, ENDE_CEP, ENDE_ENDERECO, ENDE_BAIRRO, ENDE_CIDADE, ENDE_TELEFONE, ENDE_DDDCELULAR, ENDE_CELULAR, ENDE_WHATSAPP, CNPJ, INSCESTAD, INSCMUNIC, NASCIMENTO, SEXO, ESTCIVIL, PROFISSAO, CPF, IDENTIDADE, ORGAO, EMISSAO, EMAIL, RECEMAIL, ATIVO, DESDE, QTODESMAR, MIDIA) VALUES (4, '123 Industria Ltda', '123', 1, 2, '', '', NULL, NULL, '', 0, '', 0, '', '', '', NULL, NULL, NULL, NULL, '', '', '', NULL, '', 0, 1, '2021-05-31', 0, NULL);
COMMIT WORK;

--* ARQPLANO
INSERT INTO ARQPLANO (IDPRIMARIO, CODPLANO, PLANO, TPGREC) VALUES (1, 1, 'Pessoal', 1);
INSERT INTO ARQPLANO (IDPRIMARIO, CODPLANO, PLANO, TPGREC) VALUES (2, 2, 'Administrativo', 1);
INSERT INTO ARQPLANO (IDPRIMARIO, CODPLANO, PLANO, TPGREC) VALUES (50, 50, 'Receitas', 2);
COMMIT WORK;

--*
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (1, 1, '01', 'Folha');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (2, 1, '02', 'Férias');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (3, 2, '01', 'Aluguel');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (4, 2, '02', 'Telefones');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (5, 2, '0201', 'Fixo');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (6, 2, '0202', 'Celular');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (7, 50, '01', 'Consultas');
INSERT INTO ARQSUBPLANO (IDPRIMARIO, PLANO, CODIGO, NOME) VALUES (8, 50, '02', 'Tratamentos');
COMMIT WORK;

--* arqCONTA
INSERT INTO ARQCONTA (IDPRIMARIO, TRANSACAO, CLINICA, TPGREC, PESSOA, TRGVALOR, TRGVALLIQ, TRGQTDPARC, TRGQPARCPG, PROXVENC, TRGPAGO, DOCUMENTO, EMISSAO, RECENVIA, COMPETE, HISTORICO, ARQ1) VALUES (1, 1, 1, 1, 4, 0, 0, 0, 0, NULL, 0, 123, '2021-05-31', '2021-05-31', '2021-05-01', 'Compra na 123', NULL);
INSERT INTO ARQCONTA (IDPRIMARIO, TRANSACAO, CLINICA, TPGREC, PESSOA, TRGVALOR, TRGVALLIQ, TRGQTDPARC, TRGQPARCPG, PROXVENC, TRGPAGO, DOCUMENTO, EMISSAO, RECENVIA, COMPETE, HISTORICO, ARQ1) VALUES (2, 2, 2, 1, 4, 0, 0, 0, 0, NULL, 0, 987, '2021-05-28', '2021-05-28', '2021-05-01', 'Compra na 123 de Rio de Janeiro', NULL);
INSERT INTO ARQCONTA (IDPRIMARIO, TRANSACAO, CLINICA, TPGREC, PESSOA, TRGVALOR, TRGVALLIQ, TRGQTDPARC, TRGQPARCPG, PROXVENC, TRGPAGO, DOCUMENTO, EMISSAO, RECENVIA, COMPETE, HISTORICO, ARQ1) VALUES (3, 3, 1, 2, 1, 0, 0, 0, 0, NULL, 0, 0, '2021-05-31', '2021-05-31', '2021-05-01', 'Receber do João em Niterói', NULL);
COMMIT WORK;
